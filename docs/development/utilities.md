...
effective. To facilitate this, `chatbot` offers a user-friendly prompt engineering UI
...
2. [tech] Export pipeline to config: `$ chatbot promptui export <module.path.piplineclass> --output <path/to/config/file.yml>`
3. [tech] Customize the config
4. [tech] Spin up prompt engineering UI: `$ chatbot promptui run <path/to/config/file.yml>`
...
```shell
$ chatbot promptui export <module.path.piplineclass> --output <path/to/config/file.yml>
```
...
```shell
$ chatbot promptui run <path/to/config/file.yml>
```
