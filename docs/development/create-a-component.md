...
A fundamental concept in chatbot is "component".
...
and a component! Because of that, in chatbot, we will consider them the
same as "component".

To define a component, you will:

1. Create a class that subclasses from `chatbot.base.BaseComponent`
...
from chatbot.parsers import RegexExtractor
