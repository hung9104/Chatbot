...
from chatbot_app.utils.lang import SUPPORTED_LANGUAGE_MAP
...
KH_APP_DATA_DIR = this_dir / "chatbot_app_data"
...
KH_WEB_SEARCH_BACKEND = (
    "chatbot.indices.retrievers.tavily_web_search.WebSearch"
    # "chatbot.indices.retrievers.jina_web_search.WebSearch"
)

KH_DOCSTORE = {
    # "__type__": "chatbot.storages.ElasticsearchDocumentStore",
    # "__type__": "chatbot.storages.SimpleFileDocumentStore",
    "__type__": "chatbot.storages.LanceDBDocumentStore",
    "path": str(KH_USER_DATA_DIR / "docstore"),
}
KH_VECTORSTORE = {
    # "__type__": "chatbot.storages.LanceDBVectorStore",
    "__type__": "chatbot.storages.ChromaVectorStore",
    # "__type__": "chatbot.storages.MilvusVectorStore",
    # "__type__": "chatbot.storages.QdrantVectorStore",
...
if config("AZURE_OPENAI_API_KEY", default="") and config(
    ...
    if config("AZURE_OPENAI_CHAT_DEPLOYMENT", default=""):
        KH_LLMS["azure"] = {
            "spec": {
                "__type__": "chatbot.llms.AzureChatOpenAI",
                "temperature": 0,
    ...
    if config("AZURE_OPENAI_EMBEDDINGS_DEPLOYMENT", default=""):
        KH_EMBEDDINGS["azure"] = {
            "spec": {
                "__type__": "chatbot.embeddings.AzureOpenAIEmbeddings",
                "azure_endpoint": config("AZURE_OPENAI_ENDPOINT", default=""),
                "api_key": config("AZURE_OPENAI_API_KEY", default=""),
                "api_version": config("OPENAI_API_VERSION", default="")
                or "2024-02-15-preview",
...
if OPENAI_API_KEY:
    KH_LLMS["openai"] = {
        "spec": {
            "__type__": "chatbot.llms.ChatOpenAI",
            "temperature": 0,
    ...
    KH_EMBEDDINGS["openai"] = {
        "spec": {
            "__type__": "chatbot.embeddings.OpenAIEmbeddings",
...
if VOYAGE_API_KEY:
    KH_EMBEDDINGS["voyageai"] = {
        "spec": {
            "__type__": "chatbot.embeddings.VoyageAIEmbeddings",
    ...
    KH_RERANKINGS["voyageai"] = {
        "spec": {
            "__type__": "chatbot.rerankings.VoyageAIReranking",
            "model_name": "rerank-2",
            "api_key": VOYAGE_API_KEY,
        },
        "default": False,
...
if config("LOCAL_MODEL", default=""):
    ...
    KH_LLMS["ollama-long-context"] = {
        "spec": {
            "__type__": "chatbot.llms.LCOllamaChat",
    ...
    KH_EMBEDDINGS["fast_embed"] = {
        "spec": {
            "__type__": "chatbot.embeddings.FastEmbedEmbeddings",
...
KH_LLMS["claude"] = {
    "spec": {
        "__type__": "chatbot.llms.chats.LCAnthropicChat",
...
KH_LLMS["google"] = {
    "spec": {
        "__type__": "chatbot.llms.chats.LCGeminiChat",
...
KH_LLMS["cohere"] = {
    "spec": {
        "__type__": "chatbot.llms.chats.LCCohereChat",
...
KH_EMBEDDINGS["cohere"] = {
    "spec": {
        "__type__": "chatbot.embeddings.LCCohereEmbeddings",
...
KH_EMBEDDINGS["google"] = {
    "spec": {
        "__type__": "chatbot.embeddings.LCGoogleEmbeddings",
...
KH_EMBEDDINGS["mistral"] = {
    "spec": {
        "__type__": "chatbot.embeddings.LCMistralEmbeddings",
        "model": "mistral-embed",
        "api_key": config("MISTRAL_API_KEY", default="your-key"),
    },
    "default": False,
...
#     "spec": {
#         "__type__": "chatbot.embeddings.LCHuggingFaceEmbeddings",
...
KH_RERANKINGS["cohere"] = {
    "spec": {
        "__type__": "chatbot.rerankings.CohereReranking",
...
if USE_MS_GRAPHRAG:
    GRAPHRAG_INDEX_TYPES.append("chatbot_app.index.file.graph.GraphRAGIndex")
if USE_NANO_GRAPHRAG:
    GRAPHRAG_INDEX_TYPES.append("chatbot_app.index.file.graph.NanoGraphRAGIndex")
if USE_LIGHTRAG:
    GRAPHRAG_INDEX_TYPES.append("chatbot_app.index.file.graph.LightRAGIndex")

KH_INDEX_TYPES = [
    "chatbot_app.index.file.FileIndex",
    *GRAPHRAG_INDEX_TYPES,
]
...
KH_INDICES = [
    {
        ...
        "index_type": "chatbot_app.index.file.FileIndex",
    },
    *GRAPHRAG_INDICES,
]
