...
from chatbot_app.db.models import Conversation, User, engine
...
if not os.path.isdir(ASSETS_DIR):
    ASSETS_DIR = "libs/chatbot_app/chatbot_app/assets/icons"
...
class ConversationControl(BasePage):
    ...
    def on_building_ui(self):
        with gr.Row():
            title_text = "Conversations" if not KH_DEMO_MODE else "Chatbot Papers"
