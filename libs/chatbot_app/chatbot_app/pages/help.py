...
class HelpPage:
    def __init__(
        ...
        remote_content_url: str = "https://raw.githubusercontent.com/Cinnamon/chatbot",
        ...
        if KH_DEMO_MODE:
            with gr.Accordion("Create Your Own Space"):
                gr.Markdown(
                    ...
                    "Use **Create space** button to install Chatbot "
        ...
        if self.app_version:
            ...
            if (self.changelogs_cache_dir / f"{version}.md").exists():
                ...
                release_url_base = (
                    "https://api.github.com/repos/Cinnamon/chatbot/releases"
                )
