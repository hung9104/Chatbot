...
from chatbot_app.app import BaseApp
from chatbot_app.pages.chat import ChatPage
from chatbot_app.pages.help import HelpPage
from chatbot_app.pages.resources import ResourcesTab
from chatbot_app.pages.settings import SettingsPage
from chatbot_app.pages.setup import SetupPage
...
class App(BaseApp):
    ...
    def ui(self):
        ...
        with gr.Tabs() as self.tabs:
            if self.f_user_management:
                from chatbot_app.pages.login import LoginPage
    ...
    def on_subscribe_public_events(self):
        if self.f_user_management:
            from chatbot_app.db.engine import engine
