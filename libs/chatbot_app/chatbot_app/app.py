...
import gradio as gr
import pluggy
from chatbot_app import extension_protocol
from chatbot_app.assets import PDFJS_PREBUILT_DIR, ChatbotTheme
from chatbot_app.components import reasonings
from chatbot_app.exceptions import HookAlreadyDeclared, HookNotDeclared
from chatbot_app.index import IndexManager
from chatbot_app.settings import BaseSettingGroup, SettingGroup, SettingReasoningGroup
...
class BaseApp:
    ...
    def register_extensions(self):
        ...
        self.exman = pluggy.PluginManager("chatbot_app")
        self.exman.add_hookspecs(extension_protocol)
        self.exman.load_setuptools_entrypoints("chatbot_app")

        # retrieve and register extension declarations
        extension_declarations = self.exman.hook.chatbot_app_declare_extensions()
