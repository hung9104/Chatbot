...
def test_disable_telemetry_import_haystack_first():
    """Test that telemetry is disabled when chatbot lib is initiated after"""
    import os
...
@pytest.mark.usefixtures("clean_artifacts_for_telemetry")
@skip_when_haystack_not_installed
def test_disable_telemetry_import_haystack_after_chatbot():
    """Test that telemetry is disabled when chatbot lib is initiated before"""
    import os
